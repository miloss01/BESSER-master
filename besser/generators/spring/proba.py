...
from besser.BUML.metamodel.structural.structural import (
    BinaryAssociation, DateTimeType, DateType, DomainModel, Class, FloatType, Generalization, IntegerType, Method, Multiplicity, Parameter, Property, StringType, TimeDeltaType, TimeType, Type, Association, Enumeration, EnumerationLiteral
)
