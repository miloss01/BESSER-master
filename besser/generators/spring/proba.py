...
def proba_jednostavna_klasa():
    ...
    assoc = BinaryAssociation(name="onetoone", ends={
        Property(name="computer", type=computer, multiplicity=Multiplicity(1, 1), is_navigable=False),
    ...
    model = DomainModel(name="proba", types={user, thing, computer, role, hand}, generalizations={gen1}, associations={assoc, assoc2})
